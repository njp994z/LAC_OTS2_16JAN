...
const HandController4283Faceplate3A = () => {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(HAND_CONTROLLER_4283_PID_CONFIG_KEY, JSON.stringify(config));
...
export default HandController4283Faceplate3A;
