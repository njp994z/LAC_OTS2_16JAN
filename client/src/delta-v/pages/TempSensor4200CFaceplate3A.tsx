...
const TempSensor4200CFaceplate3A = () => {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(TEMP_SENSOR_4200C_PID_CONFIG_KEY, JSON.stringify(config));
      ...
      <div className="container mx-auto py-6 px-4">
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-muted/30 rounded-lg p-3 border border-border/50">
            ...
            <p className="text-sm font-mono text-foreground">{state.syncedMode}</p>
          </div>
        </div>
      </div>
    </div>
...
export default TempSensor4200CFaceplate3A;