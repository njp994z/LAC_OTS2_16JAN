...
const TurboGeneratorHistory = () => {
  const historyEvents = [
    { id: 1, time: "14:32:15", event: "Mode changed to AUTO", type: "info" },
    { id: 2, time: "14:28:00", event: "Power setpoint changed to 35 MW", type: "info" },
    { id: 3, time: "14:15:22", event: "Turbo Generator Started", type: "success" },
    { id: 4, time: "13:45:10", event: "Alarm cleared: OVERSPEED", type: "warning" },
    { id: 5, time: "13:44:55", event: "Alarm: OVERSPEED", type: "error" },
    { id: 6, time: "12:00:00", event: "Turbo Generator Stopped", type: "info" },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">Turbo Generator History</h1>
          </div>
        </div>
...
export default TurboGeneratorHistory;
