  ...
  return (
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="relative max-w-4xl mx-auto">
        <Link href="/temp-sensor/1540-TI-4825" className="inline-flex items-center gap-2 px-4 py-2 text-sm text-muted-foreground hover:text-foreground mb-6"><ArrowLeft size={18} />Back</Link>
