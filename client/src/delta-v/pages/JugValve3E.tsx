...
const JugValve3E = () => {
  ...
  useEffect(() => {
    ...
    const defaultTagName = savedConfig.TAGNAME || jugValve.name;
    const defaultDesc = savedConfig.DESC || jugValve.description;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 deltav-grid-pattern">
      <div className="container mx-auto py-8 px-4">
        <Link
          to="/settings/controller-outputs/faceplates/valve-blocks/hand-control/1540-hcv-4282"
          className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors mb-6"
        >
          <ArrowLeft size={18} />
          <span>Back to {jugValve.name}</span>
        </Link>
        ...
        <div className="bg-card/80 backdrop-blur border border-border rounded-lg p-6 max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">Faceplate 3E - {jugValve.name} {jugValve.description}</p>
            </div>
