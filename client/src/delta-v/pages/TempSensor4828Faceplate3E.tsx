...
const TempSensor4828Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4828',
    DESC: 'Pass 1 Catalyst Temp. Bottom B',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4828',
        DESC: savedConfig.DESC || 'Pass 1 Catalyst Temp. Bottom B',
...
export default TempSensor4828Faceplate3E;
