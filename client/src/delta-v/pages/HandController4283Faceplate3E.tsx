...
const HandController4283Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-H-4283',
    DESC: 'WHB Outlet dP Hand Controller',
    UNIT: 'Drying / Acid'
  });
  ...
  useEffect(() => {
    ...
    setStringFields({
      TAGNAME: savedConfig.TAGNAME || '1540-H-4283',
      DESC: savedConfig.DESC || 'WHB Outlet dP Hand Controller',
...
export default HandController4283Faceplate3E;
