...
export enum L2ConverterElement {
  ...
  "1540-TI-5224" = "1540-TI-5224",
  "1540-TI-5220" = "1540-TI-5220",
  "1540-TI-4822_TI" = "1540-TI-4822_TI",
  "1540-TI-4020" = "1540-TI-4020",
  "1540-TI-4019" = "1540-TI-4019",
  "1520-TI-2023" = "1520-TI-2023",
}
...
const L2ConverterElementsMap = (
  ...
  const tic4020 = getHookData(L2ConverterElement["1540-TIC-4020"]);
  ...
  const ti5820 = getHookData(L2ConverterElement["1540-TI-5820"]);

  // Sensors Data (Inlets - inside converter)
  const ti5224 = getHookData(L2ConverterElement["1540-TI-5224"]);
  const ti5220 = getHookData(L2ConverterElement["1540-TI-5220"]);
  const ti4822 = getHookData(
    L2ConverterElement["1540-TI-4822_TI"],
    "1540-TI-4822",
  );
  const ti4020 = getHookData(L2ConverterElement["1540-TI-4020"]);
  const ti4019 = getHookData(L2ConverterElement["1540-TI-4019"]);
  const ti2023 = getHookData(L2ConverterElement["1520-TI-2023"]);
  ...
  return {
    ...
    "1540-TIC-4020": {
      tag: L2ConverterElement["1540-TIC-4020"],
      description: "Pass 1 Inlet Temp Controller",
      type: ElementType.TemperatureController,
      blockType: BlockType.Sensor,
      ...tic4020,
      component: getFaceplate(
        "1540-TIC-4020",
        "Pass 1 Inlet Temp Controller",
        tic4020.config,
        tic4020.data,
        isLocked,
        true,
    ...
    "1540-TI-5820": {
      tag: L2ConverterElement["1540-TI-5820"],
      description: "Catalyst Pass 1 Outlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti5820,
      component: getFaceplate(
        "1540-TI-5820",
        "Catalyst Pass 1 Outlet Temperature",
        ti5820.config,
        ti5820.data,
        isLocked,
        false,
    ...
    // SENSORS (INLETS - INSIDE CONVERTER)
    "1540-TI-5224": {
      tag: L2ConverterElement["1540-TI-5224"],
      description: "Catalyst Pass 4 Inlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti5224,
      component: getFaceplate(
    ...
    "1540-TI-5220": {
      tag: L2ConverterElement["1540-TI-5220"],
      description: "Catalyst Pass 3 Inlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti5220,
      component: getFaceplate(
        "1540-TI-5220",
        "Catalyst Pass 3 Inlet Temperature",
        ti5220.config,
        ti5220.data,
        isLocked,
        false,
    ...
    "1540-TI-4822_TI": {
      tag: L2ConverterElement["1540-TI-4822_TI"],
      description: "Catalyst Pass 2 Inlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti4822,
      component: getFaceplate(
        "1540-TI-4822",
        "Catalyst Pass 2 Inlet Temperature",
        ti4822.config,
        ti4822.data,
        isLocked,
        false,
    ...
    "1540-TI-4020": {
      tag: L2ConverterElement["1540-TI-4020"],
      description: "Catalyst Pass 1 Inlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti4020,
      component: getFaceplate(
        "1540-TI-4020",
        "Catalyst Pass 1 Inlet Temperature",
        ti4020.config,
        ti4020.data,
        isLocked,
        false,
    ...
    // EXTRA SENSORS
    "1540-TI-4019": {
      tag: L2ConverterElement["1540-TI-4019"],
      description: "Pass 1 Inlet Temperature",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti4019,
      component: getFaceplate(
        "1540-TI-4019",
        "Pass 1 Inlet Temperature",
        ti4019.config,
        ti4019.data,
        isLocked,
        false,
    ...
    "1520-TI-2023": {
      tag: L2ConverterElement["1520-TI-2023"],
      description: "WHB Gas Temperature Outlet",
      type: ElementType.TemperatureSensor,
      blockType: BlockType.Sensor,
      ...ti2023,
      component: getFaceplate(
        "1520-TI-2023",
        "WHB Gas Temperature Outlet",
        ti2023.config,
        ti2023.data,
        isLocked,
        false,
