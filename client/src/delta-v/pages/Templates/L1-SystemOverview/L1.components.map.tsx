...
const L1SystemElementsMap = (
  ...
  const furnaceOutletTemperature4200A1Config = getControllerConfig(
    L1SystemElement["1540-TI-4200A"],
  );
  const furnaceOutletTemperature4200A1Data = useControllerSync(
    L1SystemElement["1540-TI-4200A"],
  );

  //1540-TI-4200A-2
  //Furnace Outlet Temperature A
  const furnaceOutletTemperature4200A2Config = getControllerConfig(
    L1SystemElement["1540-TI-4200A"],
  );
  const furnaceOutletTemperature4200A2Data = useControllerSync(
    L1SystemElement["1540-TI-4200A"],
  );
  ...
  const pass1OutletTemperature5820Config = getControllerConfig(
    L1SystemElement["1540-TI-5820"],
  );
  const pass1OutletTemperature5820Data = useControllerSync(
    L1SystemElement["1540-TI-5820"],
  );
  ...
  return {
    ...
    "1540-PI-4002": {
      tag: L1SystemElement["1540-PI-4002"],
    ...
    "1540-FCV-2602": {
      tag: L1SystemElement["1540-FCV-2602"],
      ...
      component: <div
        className={`w-full p-4 h-full flex items-center justify-center overflow-hidden ${isLocked ? 'cursor-pointer' : ''}`}
        onClick={() => {
          console.group('1540-FCV-2602')
          console.log('sulfurControllerValve2602Data', sulfurControllerValve2602Data)
          console.log('sulfurControllerValve2602Config', sulfurControllerValve2602Config)
          console.groupEnd()
        }}
        style={{
          //   transform: `scale(${Math.min(tempSensor4200CSize.width / 180, tempSensor4200CSize.height / 120)})`,
      ...
      >
        <ValveFaceplate
          data={{
            ...
            showOutputPathIndicator: sulfurControllerValve2602Config.SHOW_OUTPUT_PATH_INDICATOR,
            showInterlockIndicator: sulfurControllerValve2602Config.SHOW_INTERLOCK_INDICATOR,
            showInterlockDiamond: sulfurControllerValve2602Config.SHOW_INTERLOCK_DIAMOND_INDICATOR,
            showLockIndicator: sulfurControllerValve2602Config.SHOW_LOCK_INDICATOR,
            showAlarmCircle: sulfurControllerValve2602Config.SHOW_ALARM_CIRCLE,
            showNoSymbol: sulfurControllerValve2602Config.SHOW_NO_SYMBOL,
            showBlueAlarmIndicator: sulfurControllerValve2602Config.SHOW_BLUE_ALARM_INDICATOR,
            showBadIOIndicator: sulfurControllerValve2602Config.SHOW_BAD_IO_INDICATOR,
            showModuleNotRunning: sulfurControllerValve2602Config.SHOW_MODULE_NOT_RUNNING,
            showValveTypeLabel: sulfurControllerValve2602Config.SHOW_VALVE_TYPE_LABEL,
            holdActive: sulfurControllerValve2602Config.HOLD_ACTIVE ?? false,
            valveTypeAction: sulfurControllerValve2602Config.VALVE_TYPE_ACTION || 'DA',
          }}
          isTransparent={true}
    ...
    "1540-F-2602": {
      tag: L1SystemElement["1540-F-2602"],
    ...
    "1540-PI-2604": {
      tag: L1SystemElement["1540-PI-2604"],
    ...
    "1540-TI-4020": {
      tag: L1SystemElement["1540-TI-4020"],
    ...
    "1540-HCV-4282": {
      tag: L1SystemElement["1540-HCV-4282"],
      ...
      >
        <ValveFaceplate
          data={{
            ...
            showOutputPathIndicator: jugControllerValve4282Config.SHOW_OUTPUT_PATH_INDICATOR,
            showInterlockIndicator: jugControllerValve4282Config.SHOW_INTERLOCK_INDICATOR,
            showInterlockDiamond: jugControllerValve4282Config.SHOW_INTERLOCK_DIAMOND_INDICATOR,
            showLockIndicator: jugControllerValve4282Config.SHOW_LOCK_INDICATOR,
            showAlarmCircle: jugControllerValve4282Config.SHOW_ALARM_CIRCLE,
            showNoSymbol: jugControllerValve4282Config.SHOW_NO_SYMBOL,
            showBlueAlarmIndicator: jugControllerValve4282Config.SHOW_BLUE_ALARM_INDICATOR,
            showBadIOIndicator: jugControllerValve4282Config.SHOW_BAD_IO_INDICATOR,
            showModuleNotRunning: jugControllerValve4282Config.SHOW_MODULE_NOT_RUNNING,
            showValveTypeLabel: jugControllerValve4282Config.SHOW_VALVE_TYPE_LABEL,
            holdActive: jugControllerValve4282Config.HOLD_ACTIVE ?? false,
            valveTypeAction: jugControllerValve4282Config.VALVE_TYPE_ACTION || 'DA',
          }}
          isTransparent={true}
    ...
    "1540-TIC-4822": {
      tag: L1SystemElement["1540-TIC-4822"],
    ...
    "1540-TI-5820": {
      tag: L1SystemElement["1540-TI-5820"],
      description: "IPAT Acid Outlet Temperature",
      type: ElementType.TemparatureSensor,
      blockType: BlockType.Sensor,
      data: pass1OutletTemperature5820Data,
      config: pass1OutletTemperature5820Config,
      component: <div
        className={`w-full p-4 h-full flex items-center justify-center overflow-hidden ${isLocked ? 'cursor-pointer' : ''}`}
      ...
      >
        <TempSensorPrimaryFaceplate
          data={{
            ...defaultControllerData,
            instrumentTag: pass1OutletTemperature5820Config?.TAGNAME,
            description: pass1OutletTemperature5820Config?.DESC || 'DT Gas Out Temperature',
            pv: pass1OutletTemperature5820Data?.state?.syncedPV ?? 0,
            sp: pass1OutletTemperature5820Data?.state?.syncedSP ?? 0,
            out: pass1OutletTemperature5820Data?.state?.syncedOUT ?? 0,
            mode: pass1OutletTemperature5820Data?.state?.syncedMode ?? 'AUTO',
            pvUnits: pass1OutletTemperature5820Config?.EU || '°C',
            pvRangeMin: pass1OutletTemperature5820Config?.SP_LIM_LO ?? 0,
            pvRangeMax: pass1OutletTemperature5820Config?.SP_LIM_HI ?? 500,
            alarmActive: pass1OutletTemperature5820Data?.state?.alarmStates?.HH || pass1OutletTemperature5820Data?.state?.alarmStates?.H ||
              pass1OutletTemperature5820Data?.state?.alarmStates?.L || pass1OutletTemperature5820Data?.state?.alarmStates?.LL || false,
            alarmColor: (pass1OutletTemperature5820Data?.state?.alarmStates?.HH || pass1OutletTemperature5820Data?.state?.alarmStates?.LL) ? 'red' :
              (pass1OutletTemperature5820Data?.state?.alarmStates?.H || pass1OutletTemperature5820Data?.state?.alarmStates?.L) ? 'yellow' : undefined,
            alarmLL: pass1OutletTemperature5820Config?.ALM_LL_LIM,
            alarmL: pass1OutletTemperature5820Config?.ALM_L_LIM,
            alarmH: pass1OutletTemperature5820Config?.ALM_H_LIM,
            alarmHH: pass1OutletTemperature5820Config?.ALM_HH_LIM,
          } as ControllerData}
          isTransparent={true}
        />
      </div>
    ...
    "1560-TG-001": {
      tag: L1SystemElement["1560-TG-001"],
    ...
    "1540-TIC-5224": {
      tag: L1SystemElement["1540-TIC-5224"],
    ...
    "1540-TI-7225": {
      tag: L1SystemElement["1540-TI-7225"],
    ...
    "1540-TIC-5220": {
      tag: L1SystemElement["1540-TIC-5220"],
      description: "Pass 2 Inlet Temperature",
      type: ElementType.TemperatureController,
      blockType: BlockType.Controller,
    ...
    "1540-TI-5232": {
      tag: L1SystemElement["1540-TI-5232"],
    ...
    "1540-TIC-7221": {
      tag: L1SystemElement["1540-TIC-7221"],
    ...
    "1540-TI-5231": {
      tag: L1SystemElement["1540-TI-5231"],
    ...
    "1540-TI-8421": {
      tag: L1SystemElement["1540-TI-8421"],
      ...
      >
        <TempSensorPrimaryFaceplate
          data={{
            ...
            alarmH: cipInletTemperature8421Config?.ALM_H_LIM,
            alarmHH: cipInletTemperature8421Config?.ALM_HH_LIM,
          } as ControllerData}
          isTransparent={true}
        />
      </div>
    ...
    "1540-TIC-7224": {
      tag: L1SystemElement["1540-TIC-7224"],
    ...
    "1520-TI-6624": {
      tag: L1SystemElement["1520-TI-6624"],
    ...
    "1540-TI-4200A": {
      ...
      type: ElementType.TemparatureSensor,
      blockType: BlockType.Sensor,
      data: furnaceOutletTemperature4200A1Data,
      config: furnaceOutletTemperature4200A1Config,
      component: <div
        className={`w-full p-4 h-full flex items-center justify-center overflow-hidden ${isLocked ? 'cursor-pointer' : ''}`}
      ...
      >
        <TempSensorPrimaryFaceplate
          data={{
            ...defaultControllerData,
            instrumentTag: furnaceOutletTemperature4200A1Config?.TAGNAME,
            description: furnaceOutletTemperature4200A1Config?.DESC || 'DT Gas Out Temperature',
            pv: furnaceOutletTemperature4200A1Data?.state?.syncedPV ?? 0,
            sp: furnaceOutletTemperature4200A1Data?.state?.syncedSP ?? 0,
            out: furnaceOutletTemperature4200A1Data?.state?.syncedOUT ?? 0,
            mode: furnaceOutletTemperature4200A1Data?.state?.syncedMode ?? 'AUTO',
            pvUnits: furnaceOutletTemperature4200A1Config?.EU || '°C',
            pvRangeMin: furnaceOutletTemperature4200A1Config?.SP_LIM_LO ?? 0,
            pvRangeMax: furnaceOutletTemperature4200A1Config?.SP_LIM_HI ?? 500,
            alarmActive: furnaceOutletTemperature4200A1Data?.state?.alarmStates?.HH || furnaceOutletTemperature4200A1Data?.state?.alarmStates?.H ||
              furnaceOutletTemperature4200A1Data?.state?.alarmStates?.L || furnaceOutletTemperature4200A1Data?.state?.alarmStates?.LL || false,
            alarmColor: (furnaceOutletTemperature4200A1Data?.state?.alarmStates?.HH || furnaceOutletTemperature4200A1Data?.state?.alarmStates?.LL) ? 'red' :
              (furnaceOutletTemperature4200A1Data?.state?.alarmStates?.H || furnaceOutletTemperature4200A1Data?.state?.alarmStates?.L) ? 'yellow' : undefined,
            alarmLL: furnaceOutletTemperature4200A1Config?.ALM_LL_LIM,
            alarmL: furnaceOutletTemperature4200A1Config?.ALM_L_LIM,
            alarmH: furnaceOutletTemperature4200A1Config?.ALM_H_LIM,
            alarmHH: furnaceOutletTemperature4200A1Config?.ALM_HH_LIM,
          } as ControllerData}
          isTransparent={true}
        />
      </div>
    ...
    "1540-TI-4200A-1": {
      ...
      type: ElementType.TemparatureSensor,
      blockType: BlockType.Sensor,
      data: furnaceOutletTemperature4200A2Data,
      config: furnaceOutletTemperature4200A2Config,
      component: <div
        className={`w-full p-4 h-full flex items-center justify-center overflow-hidden ${isLocked ? 'cursor-pointer' : ''}`}
      ...
      >
        <TempSensorPrimaryFaceplate
          data={{
            ...defaultControllerData,
            instrumentTag: furnaceOutletTemperature4200A2Config?.TAGNAME,
            description: furnaceOutletTemperature4200A2Config?.DESC || 'DT Gas Out Temperature',
            pv: furnaceOutletTemperature4200A2Data?.state?.syncedPV ?? 0,
            sp: furnaceOutletTemperature4200A2Data?.state?.syncedSP ?? 0,
            out: furnaceOutletTemperature4200A2Data?.state?.syncedOUT ?? 0,
            mode: furnaceOutletTemperature4200A2Data?.state?.syncedMode ?? 'AUTO',
            pvUnits: furnaceOutletTemperature4200A2Config?.EU || '°C',
            pvRangeMin: furnaceOutletTemperature4200A2Config?.SP_LIM_LO ?? 0,
            pvRangeMax: furnaceOutletTemperature4200A2Config?.SP_LIM_HI ?? 500,
            alarmActive: furnaceOutletTemperature4200A2Data?.state?.alarmStates?.HH || furnaceOutletTemperature4200A2Data?.state?.alarmStates?.H ||
              furnaceOutletTemperature4200A2Data?.state?.alarmStates?.L || furnaceOutletTemperature4200A2Data?.state?.alarmStates?.LL || false,
            alarmColor: (furnaceOutletTemperature4200A2Data?.state?.alarmStates?.HH || furnaceOutletTemperature4200A2Data?.state?.alarmStates?.LL) ? 'red' :
              (furnaceOutletTemperature4200A2Data?.state?.alarmStates?.H || furnaceOutletTemperature4200A2Data?.state?.alarmStates?.L) ? 'yellow' : undefined,
            alarmLL: furnaceOutletTemperature4200A2Config?.ALM_LL_LIM,
            alarmL: furnaceOutletTemperature4200A2Config?.ALM_L_LIM,
            alarmH: furnaceOutletTemperature4200A2Config?.ALM_H_LIM,
            alarmHH: furnaceOutletTemperature4200A2Config?.ALM_HH_LIM,
          } as ControllerData}
          isTransparent={true}
        />
      </div>
