...
const TempSensorFaceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: activeControllerId!,
    DESC: 'DT Gas Out Temperature',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    // If no saved config, use temperature-appropriate defaults
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || activeControllerId!,
        DESC: savedConfig.DESC || 'DT Gas Out Temperature',
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                {/* Section 6: Indicator Visibility */}
                <div className="bg-muted/20 rounded-lg border border-border/50 overflow-hidden">
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-slate-800/50">
                        <TableHead className="text-purple-400 font-bold" colSpan={2}>
                    ...
                    <TableBody>
                      ...
                      <TableRow>
                        <TableCell className="text-muted-foreground font-medium">Show Interlock Diamond (◇!)</TableCell>
                        <TableCell>
                          <Switch 
...
export default TempSensorFaceplate3E;
