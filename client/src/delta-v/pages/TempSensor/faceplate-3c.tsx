          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-6 mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">PV (Process Value): {state.syncedPV.toFixed(1)} C</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-white rounded" />
                <span className="text-sm text-muted-foreground">SP (Setpoint): {state.syncedSP.toFixed(1)} C</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <ChartContainer config={chartConfig} className="h-full w-full">
                <LineChart data={trendData} margin={{ top: 10, right: 30, left: 10, bottom: 10 }}>
                  ...
                  <YAxis 
                    ...
                    tickLine={false}
                    domain={[0, 500]}
                    label={{ value: 'Temp (C)', angle: -90, position: 'insideLeft', fill: 'hsl(215 20% 65%)' }}
                  />
...
export default TempSensorFaceplate3C;
