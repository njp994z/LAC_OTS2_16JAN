...
const TempSensor4828Faceplate3A = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(TEMP_SENSOR_4828_PID_CONFIG_KEY);
    if (saved) {
      try {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(TEMP_SENSOR_4828_PID_CONFIG_KEY, JSON.stringify(config));
...
export default TempSensor4828Faceplate3A;
