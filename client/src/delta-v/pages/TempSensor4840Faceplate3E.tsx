...
const TempSensor4840Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4840',
    DESC: 'Pass 2 Catalyst In',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4840',
        DESC: savedConfig.DESC || 'Pass 2 Catalyst In',
...
export default TempSensor4840Faceplate3E;
