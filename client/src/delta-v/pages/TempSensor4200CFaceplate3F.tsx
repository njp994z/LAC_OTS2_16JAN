...
const TempSensor4200CFaceplate3F = () => {
  ...
  useEffect(() => {
    ...
    (Object.keys(ALARM_INFO) as Array<keyof typeof ALARM_INFO>).forEach((alarmType) => {
      ...
      if (!wasActive && isActive) {
        ...
        addAlarmLogEntry({
          timestamp: new Date(),
          tag: config.TAGNAME || '1540-TI-4200C',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 deltav-grid-pattern">
      <div className="container mx-auto py-8 px-4">
        <Link href="/settings/controller-outputs/faceplates/temp-sensor/1540-TI-4200C" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors mb-6">
          <ArrowLeft size={18} />
...
export default TempSensor4200CFaceplate3F;
