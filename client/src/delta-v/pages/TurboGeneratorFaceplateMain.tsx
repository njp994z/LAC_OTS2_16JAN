...
const TurboGeneratorFaceplateMain = () => {
  const activeControllerId = '1560-TG-001';
  ...
  const [controllerData, setControllerData] = useState<ControllerData>({
    ...
    instrumentTag: savedConfig.TAGNAME || '1560-TG-001',
    description: savedConfig.DESC || 'Turbo Generator Set',
  ...
  useEffect(() => {
    const syncConfigFromContext = () => {
      ...
      setControllerData(prev => ({
        ...prev,
        instrumentTag: latestConfig.TAGNAME || '1560-TG-001',
        description: latestConfig.DESC || 'Turbo Generator Set',
    ...
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <Link
            to="/settings/controller-outputs/faceplates/turbo-generator-001"
            className={cn(
        ...
        <header className="mb-10 text-center">
          <h1 className={cn(
            ...
            1560-TG-001 Turbo Generator Set Faceplate
          </h1>
...
export default TurboGeneratorFaceplateMain;
