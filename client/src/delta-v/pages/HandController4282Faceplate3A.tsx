...
const HandController4282Faceplate3A = () => {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(HAND_CONTROLLER_4282_PID_CONFIG_KEY, JSON.stringify(config));
...
export default HandController4282Faceplate3A;
