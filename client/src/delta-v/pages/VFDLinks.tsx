...
const VFDLinks = () => {
  const linkedEquipment = [
    { id: 1, name: "Primary Compressor C-101", type: "Compressor", status: "Running" },
    { id: 2, name: "Suction Valve XV-101", type: "Valve", status: "Open" },
    { id: 3, name: "Discharge Valve XV-102", type: "Valve", status: "Open" },
    { id: 4, name: "Pressure Transmitter PT-101", type: "Sensor", status: "Normal" },
    { id: 5, name: "Temperature Transmitter TT-101", type: "Sensor", status: "Normal" },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">VFD Links</h1>
          </div>
        </div>
