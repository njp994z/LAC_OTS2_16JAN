...
const TempSensor5231Faceplate3E = () => {
  const activeControllerId = '1540-TI-5231';
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-5231',
    DESC: 'Pass 3 Duct Outlet Temp.',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-5231',
        DESC: savedConfig.DESC || 'Pass 3 Duct Outlet Temp.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 deltav-grid-pattern">
      <div className="container mx-auto py-8 px-4">
        <Link
          to="/settings/controller-outputs/faceplates/temp-sensor/1540-TI-5231"
          className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors mb-6"
        >
          <ArrowLeft size={18} />
          <span>Back to 1540-TI-5231 Temperature Sensor</span>
        </Link>
...
export default TempSensor5231Faceplate3E;
