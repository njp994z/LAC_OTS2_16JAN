...
const TurboGeneratorAlarms = () => {
  const alarms = [
    { id: 1, time: "14:32:15", param: "OVERSPEED", severity: "high", active: true, acknowledged: false },
    { id: 2, time: "13:45:10", param: "HIGH_BEARING_TEMP", severity: "medium", active: false, acknowledged: true },
    { id: 3, time: "12:20:00", param: "LOW_OIL_PRESSURE", severity: "low", active: false, acknowledged: true },
    { id: 4, time: "10:15:30", param: "VIBRATION_HIGH", severity: "high", active: false, acknowledged: true },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">Turbo Generator Alarms</h1>
          </div>
        </div>
...
export default TurboGeneratorAlarms;
