...
const HomeScreen = () => {
  ...
  const readUrlParams = useCallback(() => {
    ...
    if (screenParam) {
      ...
      if (matchedOption) {
        setSelectedScreen(matchedOption.label);
      }
    }
    ...
    <div className="h-screen bg-white flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        ...
        {selectedScreen === "L1 – System Overview" && (
          <L1SystemOverview
            simulationTriggerRef={l1SimTriggerRef}
            highlightBlock={highlightedBlock}
          />
        )}
        {selectedScreen === "L2 – Converter" && (
          <L2Converter highlightBlock={highlightedBlock} />
        )}
        {selectedScreen === "L2 1520 ACID" && (
          <L2_1520_ACID highlightBlock={highlightedBlock} />
        )}
      </div>

      {/* Alarm Banner is now handled globally in App.tsx */}
      ...
      >
        <DialogContent className="max-w-fit p-0 bg-transparent border-none shadow-none [&>button]:hidden">
          ...
          <SecondaryControllerFaceplate
            ...
            onModelockOverrideChange={setWhbHandControllerModelockOverride}
          />
        </DialogContent>
      </Dialog>
