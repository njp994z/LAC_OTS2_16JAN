...
const TempSensor4821Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4821',
    DESC: 'Pass 1 Temperature',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4821',
        DESC: savedConfig.DESC || 'Pass 1 Temperature',
...
export default TempSensor4821Faceplate3E;
