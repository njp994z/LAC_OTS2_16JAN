      ...
      <div className="relative text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-4 items-center">
          {[
            ...
            { to: "/settings/controller-outputs/faceplates/controller/1540-T-4822", label: "1540-T-4822 Pass 2 Inlet Temperature Controller" },
            { to: "/settings/controller-outputs/faceplates/controller/1540-T-5220", label: "1540-T-5220 Pass 3 Inlet Temperature Controller" },
            { to: "/settings/controller-outputs/faceplates/controller/1540-T-5224", label: "1540-T-5224 Pass 4 Inlet Temperature Controller" },
            { to: "/settings/controller-outputs/faceplates/controller/1540-T-7221", label: "1540-T-7221 Econ 4A Outlet Temperature Controller" },
            { to: "/settings/controller-outputs/faceplates/controller/1540-T-7224", label: "1540-T-7224 Econ 3B Outlet Temperature Controller" },
          ].map(({ to, label }) => (
            <Link
              key={to}
              href={to}
