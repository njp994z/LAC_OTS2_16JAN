...
const TempSensor4826Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4826',
    DESC: 'Pass 1 Catalyst Temp. Top B',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4826',
        DESC: savedConfig.DESC || 'Pass 1 Catalyst Temp. Top B',
...
export default TempSensor4826Faceplate3E;
