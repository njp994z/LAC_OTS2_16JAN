...
const MainCompressorHandControllerFaceplateMain = () => {
  ...
  const [controllerData, setControllerData] = useState<ControllerData>({
    ...
    instrumentTag: savedConfig.TAGNAME || '1540-H-4030',
    description: savedConfig.DESC || 'Main Compressor Hand Controller',
  ...
  useEffect(() => {
    const syncConfigFromContext = () => {
      ...
      setControllerData(prev => ({
        ...prev,
        instrumentTag: latestConfig.TAGNAME || '1540-H-4030',
        description: latestConfig.DESC || 'Main Compressor Hand Controller',
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <header className="mb-10 text-center">
          <h1 className={cn(
            ...
            1540-H-4030 Main Compressor Hand Controller Faceplate
          </h1>
...
export default MainCompressorHandControllerFaceplateMain;
