...
const TempSensor4820Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4820',
    DESC: 'Pass 1 Inlet Duct',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4820',
        DESC: savedConfig.DESC || 'Pass 1 Inlet Duct',
...
export default TempSensor4820Faceplate3E;
