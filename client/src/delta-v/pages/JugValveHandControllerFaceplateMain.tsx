...
const JugValveHandControllerFaceplateMain = () => {
  const activeControllerId = '1540-H-4282';
  ...
  const [controllerData, setControllerData] = useState<ControllerData>({
    ...
    instrumentTag: savedConfig.TAGNAME || '1540-H-4282',
    description: savedConfig.DESC || 'Jug Valve Hand Controller',
  ...
  useEffect(() => {
    const syncConfigFromContext = () => {
      ...
      setControllerData(prev => ({
        ...prev,
        instrumentTag: latestConfig.TAGNAME || '1540-H-4282',
        description: latestConfig.DESC || 'Jug Valve Hand Controller',
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <header className="mb-10 text-center">
          <h1 className={cn(
            ...
            1540-H-4282 Jug Valve Hand Controller Faceplate
          </h1>
...
export default JugValveHandControllerFaceplateMain;
