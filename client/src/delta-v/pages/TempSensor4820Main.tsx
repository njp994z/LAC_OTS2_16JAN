...
const TempSensor4820Main = () => {
  ...
  const [controllerData, setControllerData] = useState<ControllerData>({ ...defaultControllerData, instrumentTag: '1540-TI-4820', description: 'Pass 1 Inlet Duct', pvUnits: 'F', pvRangeMin: 0, pvRangeMax: 2000 });
    ...
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="flex flex-col items-center gap-2"><span className="text-xs text-muted-foreground uppercase">Secondary</span><TempSensorSecondaryFaceplate data={secondaryData} config={config} sensorId="1540-TI-4820" /></div>
        </div>
      </div>
    </div>
  );
};
export default TempSensor4820Main;
