...
const HandController4282Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-H-4282',
    DESC: 'Jug Valve Hand Controller',
    UNIT: 'Drying / Acid'
  });
  ...
  useEffect(() => {
    ...
    setStringFields({
      TAGNAME: savedConfig.TAGNAME || '1540-H-4282',
      DESC: savedConfig.DESC || 'Jug Valve Hand Controller',
...
export default HandController4282Faceplate3E;
