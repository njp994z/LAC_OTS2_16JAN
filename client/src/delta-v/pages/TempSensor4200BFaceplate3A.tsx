...
const TempSensor4200BFaceplate3A = () => {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(TEMP_SENSOR_4200B_PID_CONFIG_KEY, JSON.stringify(config));
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 deltav-grid-pattern">
      <div className="container mx-auto py-6 px-4">
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-muted/30 rounded-lg p-3 border border-border/50">
            <h3 className="text-xs font-medium text-muted-foreground mb-1">Service</h3>
            <p className="text-sm font-mono text-foreground">{config.service_desc}</p>
          </div>
          <div className="bg-muted/30 rounded-lg p-3 border border-border/50">
            <h3 className="text-xs font-medium text-muted-foreground mb-1">Units</h3>
            <p className="text-sm font-mono text-foreground">{config.eng_units}</p>
          </div>
          <div className="bg-muted/30 rounded-lg p-3 border border-border/50">
            <h3 className="text-xs font-medium text-muted-foreground mb-1">Current Mode</h3>
            <p className={`text-sm font-mono ${
              config.mode === 'AUTO' ? 'text-green-400' :
              config.mode === 'MAN' ? 'text-orange-400' :
              'text-cyan-400'
            }`}>{config.mode}</p>
          </div>
        </div>
...
export default TempSensor4200BFaceplate3A;