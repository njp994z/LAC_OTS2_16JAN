...
const SulfurFlowControllerFaceplateMain = () => {
  const activeControllerId = '1530-F-2602';
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <header className="mb-10 text-center">
          <h1 className={cn(
            ...
            1530-F-2602 Sulfur Flow Controller Faceplate
          </h1>
...
export default SulfurFlowControllerFaceplateMain;
