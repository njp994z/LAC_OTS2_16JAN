...
const TempSensor4825Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4825',
    DESC: 'Pass 1 Catalyst In',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4825',
        DESC: savedConfig.DESC || 'Pass 1 Catalyst In',
...
export default TempSensor4825Faceplate3E;
