...
const TempSensor4827Faceplate3A = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem(TEMP_SENSOR_4827_PID_CONFIG_KEY);
    if (saved) {
      try {
  ...
  const saveConfig = useCallback(() => {
    localStorage.setItem(TEMP_SENSOR_4827_PID_CONFIG_KEY, JSON.stringify(config));
...
export default TempSensor4827Faceplate3A;
