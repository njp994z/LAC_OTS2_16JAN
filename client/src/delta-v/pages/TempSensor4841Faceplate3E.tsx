...
const TempSensor4841Faceplate3E = () => {
  ...
  const [stringFields, setStringFields] = useState({
    TAGNAME: '1540-TI-4841',
    DESC: 'Pass 2 Catalyst Out',
    UNIT: ''
  });
  ...
  useEffect(() => {
    ...
    if (!savedConfig.TAGNAME || savedConfig.TAGNAME === defaultSecondaryConfig.TAGNAME) {
      ...
      setStringFields({
        TAGNAME: savedConfig.TAGNAME || '1540-TI-4841',
        DESC: savedConfig.DESC || 'Pass 2 Catalyst Out',
...
export default TempSensor4841Faceplate3E;
