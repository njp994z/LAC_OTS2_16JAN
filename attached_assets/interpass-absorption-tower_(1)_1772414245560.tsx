...
export default function InterpassAbsorptionTower() {
  ...
  const runCalculation = useCallback(async () => {
    ...
    try {
      ...
      // Convert pressure drops (returned by API as negative deltas) to gauge pressures
      // Gauge pressure = inlet gauge pressure + pressure drop (drop is negative, so this reduces pressure)
